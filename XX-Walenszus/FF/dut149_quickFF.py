...
log_out = 'dut149_FF/dut149_FF_quickFF.log'
...
fn_out = 'dut149_FF/dut149_FF_quickFF.txt'
chk_out = 'dut149_FF/dut149_ligand.chk'
settings = Settings(fn_yaff=fn_out, fn_sys=chk_out, plot_traj='Final', xyz_traj=False, consistent_cross_rvs=True, vdw="dut149_FF/dut149_FF_LJ.txt", vdw_rcut=20*angstrom, ei='dut149_FF/dut149_FF_charges.out', ei_rcut=50*angstrom, bond_term='bondmm3', bend_term="bendmm3", log_level='high', pert_traj_tol=1e-6)
